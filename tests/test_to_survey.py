...
class TestToSurvey:
    ...
    def test_returns_survey_design(self, pums_df):
        result = to_survey(pums_df, type="person")
    ...
    def test_weighted_estimate(self, pums_df):
        design = to_survey(pums_df, type="person")
    ...
    def test_housing_type(self):
        ...
        design = to_survey(df, type="housing")
